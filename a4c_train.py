...
if __name__ == '__main__':
    ...
    train_a4c_dataset = CustomDataset(df=train_a4c_df, mode='train', transform=train_transform(IMGSIZE))
    ...
    test_a4c_dataset = CustomDataset(df=test_a4c_df, mode='val', transform=test_transform(IMGSIZE))
